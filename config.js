...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/1bbd8791de7c137d75070.jpg";
...
global.userImages = process.env.USER_IMAGES || "https://i.imgur.com/0VzMwmd.jpeg";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "𝐅 𝐄 𝐋 𝚰 𝐗",
  botname: process.env.BOT_NAME || "𝐅𝖾ᥣ𝗂𝗑",
  ownername: process.env.OWNER_NAME || "𝐅 𝐄 𝐋 𝚰 𝐗",
